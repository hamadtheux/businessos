...
const styles: Record<string, CSSProperties> = {
  page: {
    minHeight: "100dvh",
    background:
      "radial-gradient(circle at top left, rgba(18, 104, 243,0.10), transparent 34%), #F8FAFC",
    color: "#101828",
  },
  header: {
    position: "sticky",
  ...
  button: {
    ...
    fontSize: 14,
    fontWeight: 750,
    boxShadow: "0 8px 24px rgba(18, 104, 243,0.18)",
  },
  secondaryButton: {
    display: "inline-flex",
    alignItems: "center",
  ...
  legalCard: {
    ...
    boxShadow: "0 24px 70px rgba(16, 24, 40,0.05)",
  },
  section: {
    padding: "28px 0",
    borderBottom: "1px solid rgba(16, 24, 40,0.08)",
