...
export function SocialManagementPage() {
  ...
  const createBrief = useMutation({
    ...
    onSuccess: () => {
      setBriefing(false);
      setNotice(
        "Creative brief was saved. No binary asset was generated by this step.",
      );
      setError("");
      void invalidate();
    },
    ...
    <>
      ...
      {selected && (
        ...
        >
          ...
          <div className="ai-banner">
            <AlertCircle /> Binary creative generation is a separate provider
            step. Publishing always requires AIAction policy and approval. {selectedProviderCopy}
          </div>
        </Modal>
      )}
      {editing && selected && (
