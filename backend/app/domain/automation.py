...
TRIGGER_TYPES = frozenset({
    ...
    "conversation_human_takeover", "conversation_ai_resumed",
    "conversation_ai_paused", "conversation_resolved", "conversation_reopened",
    "support_case_created", "support_case_updated", "support_case_escalated",
