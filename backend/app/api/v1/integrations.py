...
@router.get(
    "/businesses/{business_id}/integrations/connections/{connection_id}/mail/messages/{message_reference}",
    response_model=ExternalMailMessageContentResponse,
)
